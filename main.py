...
mimic walking motion in a plane. Step location selection is according to
the XCOM + offset. Step time selection is according to a minimization of 
the step-to-step transition cost and the swing leg cost, given the XCOM-
based stepping location.
"""
